...
export class McpTools {
  ...
  constructor(queryRAG: any, inspector: any = null) {
   ...
   */
  async getRagStats(args: any): Promise<{ systemStatus: string; timestamp: string; inspectorEnabled: boolean; [key: string]: any; }> {
   ...
   *  Remove query
   */
  async removeQuery(args: any): Promise<{ success: boolean; queryId: string; message: string; }> {
    const { queryId } = args;
